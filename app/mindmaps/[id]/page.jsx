...
// Custom node types (you can expand these)
const nodeTypes = {};
...
export default function MindmapDetail({ params }) {
  ...
  return (
    <div className="container mx-auto px-0 py-4 flex flex-col h-[calc(100vh-80px)]">
      {/* Header */}
      <div className="flex justify-between items-center mb-4 px-4">
        <div className="flex items-center space-x-4">
          <Button variant="ghost" size="sm" onClick={() => router.push('/mindmaps')}>
        ...
        <div className="flex items-center space-x-2">
          ...
          <Button size="sm" variant="outline" onClick={handleSave} disabled={updateMindmap.isPending}>
            <Save className="h-4 w-4 mr-2" />
            {updateMindmap.isPending ? 'Saving...' : 'Save'}
          </Button>
      ...
      <div className="flex-grow border rounded-md" ref={reactFlowWrapper}>
        <ReactFlow
          nodes={nodes}
          edges={edges}
