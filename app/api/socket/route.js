...
export async function GET(req) {
  try {
    ...
    // If socket.io server is already created for this Next.js instance, return early
    ...
    io.use((socket, next) => {
      ...
      // You could verify the token here with your auth system
      // For now we'll just attach user data to the socket
